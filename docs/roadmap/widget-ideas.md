...
| **Window menu** | Dropdown listing all open windows to jump to one | same Meta window enumeration + `PopupMenu` | low–medium | **Built**, scoped to the focused application: [`app-windows`](../../extension-src/plugins/app-windows/index.md). A full all-applications list is still open |
