...
| Tag | Description |
| --- | --- |
| `process` | Contributor/agent process rules: how to file a bug, the staged bug-fixing workflow (with subagents) and the code-quality rules that keep change cost flat (`docs/bug-report-howto.md`, `docs/bug-fixing-workflow.md`, `docs/code-quality.md`, `.github/ISSUE_TEMPLATE/`, `AGENTS.md` Process section). |
